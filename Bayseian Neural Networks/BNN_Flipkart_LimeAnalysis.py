# ============================================================
# LIME Explanation Dashboard for Flipkart Dataset - BNN
# Baseline/non-LLM features + best 15 LLM-derived features
# ============================================================
...
DATA_PATH = os.path.join(
    WORK_DIR,
    "flipkart_merged_original_withllm_features.csv"
)

OUTPUT_HTML = os.path.join(
    WORK_DIR,
    "bnn_flipkart_lime_dashboard_top15_llm_baseline_features.html"
)
...
def display_name(col):
    """
    Keeps baseline features unchanged and ensures LLM-derived features
...
# ============================================================
# 7. IDENTIFY NON-LLM FEATURES AND LLM FEATURES
# ============================================================
...
@torch.no_grad()
def predict_from_raw(X_input_raw, sample=False):
...
y_pred_test = predict_from_raw(X_test, sample=False)
...
def lime_predict(display_array):
    ...
    return predict_from_raw(actual_df, sample=False)
...
<head>
<meta charset="utf-8">
<title>BNN Flipkart LIME Dashboard</title>
...
<body>
    <h1>BNN Flipkart – Single-Instance Explanation Dashboard</h1>
...
print("\nBNN Flipkart LIME dashboard saved to:")
print(OUTPUT_HTML)
