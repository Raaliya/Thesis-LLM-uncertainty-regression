# ============================================================
# SHAP Explanation for Flipkart Dataset - Deep Ensembles
...
OUTPUT_DIR = r"D:\MAT-UNI\SEMESTER 02\THESIS\VS Code Implementation 1.2\1 BNN_ShapLime\SHAP_DE_Flipkart"
...
print("\nFinal features used for Flipkart Deep Ensembles + SHAP:")
...
bar_path = os.path.join(OUTPUT_DIR, "flipkart_de_shap_bar.png")
beeswarm_path = os.path.join(OUTPUT_DIR, "flipkart_de_shap_beeswarm.png")
waterfall_path = os.path.join(OUTPUT_DIR, "flipkart_de_shap_waterfall.png")
combined_path = os.path.join(OUTPUT_DIR, "flipkart_de_shap_combined.png")
...
fig.suptitle(
    "Figure: SHAP-based explanation for Flipkart dataset using Deep Ensembles model",
    fontsize=18,
    y=0.02
)
...
feature_list_path = os.path.join(
    OUTPUT_DIR,
    "selected_features_for_flipkart_de_shap.csv"
)
...
local_distribution = ensemble_predict_distribution_single(local_raw)
...
local_summary_path = os.path.join(
    OUTPUT_DIR,
    "flipkart_de_local_prediction_summary.csv"
)
