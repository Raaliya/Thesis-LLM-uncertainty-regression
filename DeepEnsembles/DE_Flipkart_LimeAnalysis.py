# ============================================================
# LIME Explanation Dashboard for Flipkart Dataset - Deep Ensembles
...
OUTPUT_HTML = os.path.join(
    WORK_DIR,
    "de_flipkart_lime_dashboard_top15_llm_baseline_features.html"
)
...
def display_name(col):
    """
    Keeps baseline/non-LLM features unchanged and ensures LLM-derived
    features are visibly differentiated with llm_.
    """
    col = str(col)
...
<head>
<meta charset="utf-8">
<title>DE Flipkart LIME Dashboard</title>
...
<body>
    <h1>DE Flipkart – Single-Instance Explanation Dashboard</h1>
...
# ============================================================
# 19. SAVE AND OPEN HTML
# ============================================================

with open(OUTPUT_HTML, "w", encoding="utf-8") as f:
    f.write(full_html)

print("\nDE Flipkart LIME dashboard saved to:")
print(OUTPUT_HTML)

# Safer Windows-compatible way to open the HTML file
