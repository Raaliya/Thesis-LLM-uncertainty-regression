# mcd_skincare_shap.py
# Monte Carlo Dropout + SHAP for Skincare dataset
# Target: rating
...
FILE_NAME = "reviews_1000_1500_with_llm_features_2000.csv"
TARGET_COL = "rating"
...
MODEL_FILE = os.path.join(FILE_PATH, "mcd_skincare_model.pt")
SCALER_FILE = os.path.join(FILE_PATH, "mcd_skincare_scaler.joblib")
PREDICTIONS_FILE = os.path.join(FILE_PATH, "mcd_skincare_predictions.csv")

BAR_PLOT_FILE = os.path.join(FILE_PATH, "mcd_skincare_shap_bar.png")
BEESWARM_PLOT_FILE = os.path.join(FILE_PATH, "mcd_skincare_shap_beeswarm.png")
WATERFALL_PLOT_FILE = os.path.join(FILE_PATH, "mcd_skincare_shap_waterfall.png")
...
y_pred_mean = np.clip(y_pred_mean, 1.0, 5.0)
